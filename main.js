...
function main() {
  ...
  function frameArea(sizeToFitOnScreen, boxSize, boxCenter, camera) {
    const halfSizeToFitOnScreen = sizeToFitOnScreen * .8;
  ...
  let curveObject;
  {
    const controlPoints = [
      ...
      [3.985447, 5.115846, 4.585005], //esquina inferior izquierda
      [-13.266233, 5.115846, 4.567083], //esquina superior izquierda
      ...
      [-13.250067, 5.115846, -13.499271], // esquina superior derecha
      [4.081842, 5.115846, -13.435463], //esquina inferior derecha
  ...
  function render(time) {
...

    {
      ...
      cars.forEach((car, ndx) => {
        ...
        // get the first point
        curve.getPointAt(u % 1, carPosition); // crea vectores interpolados entre los 4 puntos
        console.log(curve);
